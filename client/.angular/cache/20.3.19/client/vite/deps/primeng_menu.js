import {
  Tooltip,
  TooltipModule
} from "./chunk-T73CXCW4.js";
import {
  Badge,
  BadgeModule
} from "./chunk-S7P7KQEX.js";
import {
  Ripple
} from "./chunk-RTZMSEKM.js";
import {
  zindexutils
...
import {
  BaseComponent
} from "./chunk-WU5D4XG2.js";
import {
  BaseStyle
} from "./chunk-43IRF5IT.js";
import {
  OverlayService,
  PrimeTemplate,
  SharedModule
} from "./chunk-RS5NX4Y5.js";
import {
  absolutePosition,
  appendChild,
  find,
  ...
  relativePosition,
  uuid
} from "./chunk-CIXKWFNL.js";
import "./chunk-BQAWEH44.js";
import {
  animate,
  style,
  transition,
  trigger
} from "./chunk-G2VGOM2D.js";
import {
  RouterLink,
  RouterLinkActive,
  RouterModule
...
function Menu_div_0_5_ng_template_0_li_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", ctx_r1.submenuHeaderTemplate ?? ctx_r1._submenuHeaderTemplate)("ngTemplateOutletContext", ɵɵpureFunction1(10, _c2, submenu_r3));
  }
}
...
function Menu_div_0_6_ng_template_0_li_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("pMenuItemContent", item_r13)("itemTemplate", ctx_r1.itemTemplate ?? ctx_r1._itemTemplate)("ngClass", ɵɵpureFunction2(13, _c15, ctx_r1.focusedOptionId() && ctx_r1.menuitemId(item_r13, ctx_r1.id, i_r14) === ctx_r1.focusedOptionId(), ctx_r1.disabled(item_r13.disabled)))("ngStyle", item_r13.style)("tooltipOptions", item_r13.tooltipOptions);
