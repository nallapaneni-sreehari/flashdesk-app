...
function TabList_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵconditionalCreate(2, TabList_Conditional_0_Conditional_2_Template, 1, 1, "ng-container")(3, TabList_Conditional_0_Conditional_3_Template, 1, 0, "ChevronLeftIcon");
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext();
...
function TabList_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵconditionalCreate(2, TabList_Conditional_8_Conditional_2_Template, 1, 1, "ng-container")(3, TabList_Conditional_8_Conditional_3_Template, 1, 0, "ChevronRightIcon");
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext();
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function TabList_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵprojectionDef();
        ɵɵconditionalCreate(0, TabList_Conditional_0_Template, 4, 4, "button", 5);
        ...
        ɵɵelementEnd()();
        ɵɵconditionalCreate(8, TabList_Conditional_8_Template, 4, 4, "button", 9);
      }
      if (rf & 2) {
