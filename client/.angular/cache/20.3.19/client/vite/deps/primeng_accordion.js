...
function AccordionTab_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵconditionalCreate(0, AccordionTab_Conditional_2_Conditional_0_Template, 1, 1, "ng-container");
    ɵɵconditionalCreate(1, AccordionTab_Conditional_2_Conditional_1_Template, 1, 0);
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function AccordionTab_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵconditionalCreate(1, AccordionTab_Conditional_1_Template, 1, 1)(2, AccordionTab_Conditional_2_Template, 2, 2);
        ɵɵconditionalCreate(3, AccordionTab_Conditional_3_Template, 1, 4)(4, AccordionTab_Conditional_4_Template, 2, 2);
        ɵɵelementEnd();
